...
void Dcoc_Calib(uint16_t i, uint16_t q)
{
	...
	if (i > 512)
	{
		dac_i = dac_i | 0x80; //���λ����1
	}

	if (q < 512)
	{
		dac_q = dac_q << 8 | 0x8000; //���λ����1,Q��16λ
	}
...
// wbit(0x0098,15,8,"00011100");//i dcoc dac   �°���
...
void ble_rccali(void)
{
	...
	// wbit(0x0840,10,8,"101");//RG_RCCAL_CTRL(Rccal �����ֵ����) "101"
	wbit(0x0840, 10, 8, "111"); // RG_RCCAL_CTRL(Rccal �����ֵ����) "101"
	...
	while (!(rbit(0x0848) & 0x8000))
		; //�ȴ�AD_RCCAL_FINISH���� �ó�У׼ֵ AD_RCCAL_CTRIM
	val = rbit(0x0848);
