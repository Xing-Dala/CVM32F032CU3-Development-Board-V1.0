...
#define IO_READ(num)               IO_Read(num)
#define IO_WRITE(num, val)         IO_write(uint8_t num, uint8_t val)
...
extern void IO_Init(uint8_t num, uint8_t full, uint8_t mode, uint8_t interruption, uint8_t val);
