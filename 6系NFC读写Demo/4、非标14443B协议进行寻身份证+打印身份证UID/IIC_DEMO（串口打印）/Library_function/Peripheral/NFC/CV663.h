...
#define CV663_CLK_Pin   5  // SCL
#define CV663_SDA_Pin   6  // SDA
#define CV663_ADR1_Pin  21 // ADR1
#define CV663_ADR2_Pin  1  // ADR2

#define CV663_IRQ_Pin   7 // IRQ

#define CV663_SL0_Pin   20 // SL0
#define CV663_SL1_Pin   0  // SL1

#define CV663_SDA_Hight gpio_output_high(CV663_SDA_Pin)
#define CV663_CLK_Hight gpio_output_high(CV663_CLK_Pin)
#define CV663_RST_Hight gpio_output_high(CV663_RST_Pin)

#define CV663_SDA_Low   gpio_output_low(CV663_SDA_Pin)
#define CV663_CLK_Low   gpio_output_low(CV663_CLK_Pin)
#define CV663_RST_Low   gpio_output_low(CV663_RST_Pin)

#define CV663_SDA_Read  IO_Read(CV663_SDA_Pin)
