...
#define CV663_RX_Pin    21 // IF0
#define CV663_TX_Pin    1  // IF2
#define CV663_IF3_Pin   6  // IF3

#define CV663_IRQ_Pin   7 // IRQ

#define CV663_SL0_Pin   20
#define CV663_SL1_Pin   0
...
void Write_CV663(uint8_t Address, uint8_t cValue);
void SetBitMask_CV663(uint8_t cAddr, uint8_t cMask);
void ClearBitMask_CV663(uint8_t cAddr, uint8_t cMask);

uint8_t PcdReset_CV663(void);
uint8_t PcdConfig_CV663(uint8_t cType);
uint8_t PcdTransceive_CV663(uint8_t cCommand);

void PcdSetTmo_CV663(uint8_t tmoLength);
